...
export default function Signup() {
  return (
    <div className="h-screen flex flex-col justify-center items-center text-black gap-5 max-w-lg m-auto my-80">
      ...
      <div className="usersignup flex flex-col justify-start w-full gap-5">
        <Input label="What's your email?" type="email" placeholder="Enter Your Email." />
        <Input label="Create a password?" type="password" placeholder="Create a password" />
        <Input
          label="What should we call you?"
          placeholder="Enter your profile name."
        />
        <span className="text-xs font-medium">This appears on your profile.</span>
        <label className="font-bold text-sm">
          What&apos;s your date of birth?
        </label>
        <div className="flex gap-3 items-center">
          <Input label="Days" placeholder="DD" />
          <Input type="month" label="Month" />{" "}
        </div>
        <div>
          <p className="font-bold text-sm">What&apos;s your gender?</p>
          <div
            className="gender flex items-center w-full h-full text-sm font-medium gap-3
          pb-5"
          >
            <div className="flex gap-4">
              <Input type="radio" name="gender"/>
              <span className="translate-y-1">Male</span>
            </div>
            <div className="flex gap-4">
              <Input type="radio" name="gender"/>
              <span className="translate-y-1">Female</span>
            </div>
            <div className="flex gap-4">
              <Input type="radio" name="gender"/>
              <span className="translate-y-1">Non binary</span>
            </div>
            <div className="flex gap-4">
              <Input type="radio" name="gender"/>
              <span className="translate-y-1">Other</span>
            </div>
            <div className="flex gap-4">
              <Input type="radio" name="gender"/>
              <span className="translate-y-1">Prefer not to say</span>
            </div>
          </div>
        </div>
        <div className="updates text-sm font-normal">
        ...
        <div className="termandconditions">
          ...
          Conditions of Use. To learn more about how Spotify collects, uses,
          shares and protects your personal data, please see Spotify&apos;s
          Privacy Policy.
          </span>
        </div>
        <div className="signupcontainer flex flex-col justify-center items-center gap-5">
          <button className="w-36 h-12 rounded-full font-bold bg-green-500">Sign up</button>
          <p className="font-medium text-sm">Have an account? <Link href={"/login"} className=" underline">Log in.</Link></p>
        </div>
      </div>
    </div>
  );
